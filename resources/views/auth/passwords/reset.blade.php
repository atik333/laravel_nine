    ...
    <div class="card-body">
      ...
      <form method="POST" action="{{ route('password.update') }}">
        ...
        <div class="input-group mb-3">
            <input id="email" type="email" disabled placeholder="Email Address"  class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" autocomplete="email" autofocus>
